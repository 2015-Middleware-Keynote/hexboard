...
var multipaas = require('../index.js')
...
var fs = require('fs')
var ini = require('config-chain/node_modules/ini')
...
test('basic class test', function (t) {
  ...
  var default_snapshot = cc.snapshot;
  var default_list = cc.list;
  ...
  cc.addFile('/tmp/config-chain-class.json')
    ...
    .on('load', function () {
      t.same(true, cc instanceof(CC))
      t.same(multipaas.ConfigChain, CC)
//      t.same(cc.list, expectlist.concat(default_list))
